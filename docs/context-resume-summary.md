...
- Added GitHub, LinkedIn, Facebook, Instagram links, plus a broader technology stack from the attached GitHub profile text.
...
## Known Issues
- Static `mailto:` form only; no backend exists in the repo.
- Legacy unused libraries and pages remain for compatibility.

## Next Command
- `git commit -m "Rebuild portfolio landing page"`
